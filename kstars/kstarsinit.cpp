...
void KStars::initActions() {
    ...
    actionCollection()->addAction("stereoscopic", SkyMap::Instance(), SLOT( slotToggleStereoScopic() ) )
        << (!Options::stereoscopic() ? i18n("Switch to stereoscopic display"): i18n("Switch to single display"));
#endif
